...
namespace InterviewApp.Data.Base
{
    public class NhInitFactory
    {
        ...
        private readonly string[] _assemblyNames = { "InterviewApp.Domain" };

        public ISessionFactory Factory => _factory;

        public virtual IsolationLevel IsolationLevel => IsolationLevel.ReadCommitted;

        public NhInitFactory(IConnectionSettingsProvider connectionSettingsProvider)
        {
            _interceptor = new EmptyInterceptor();
